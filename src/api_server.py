...
# api_server.py está em: ...\sports-prob-engine\src\api_server.py
# PROJECT_ROOT vira:     ...\sports-prob-engine
...
def serve_sw():
    ...
    if not sw_path.exists():
        raise HTTPException(status_code=404, detail="sw.js não encontrado em /web/sw.js")
